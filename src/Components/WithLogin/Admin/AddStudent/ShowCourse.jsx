...
function ShowCourse({ course }) {
  const[{studentcourse,studentcoursesubject,user} , dispatch] = useStateValue();
      ...
      <div
        ...
        onClick={() =>
          ...
          dispatch({
            ...
            studentcourse: course.data.name,
          })
          dispatch({
            type: actionTypes.SET_STUDENT_COURSE_SUBJECT,
            studentcoursesubject: course.data.subjects,
          })
        }}
      >
        <div className="head">
